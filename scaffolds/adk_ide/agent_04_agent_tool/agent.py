"""
Agent for PyCon events suggestions.
"""
...
google_search_agent = Agent(
    ...
    description="""
    A search agent that uses google search to get
    latest information about upcoming PyCon events
    """,
    instruction="""
    Use google search find information about upcoming PyCon events.
