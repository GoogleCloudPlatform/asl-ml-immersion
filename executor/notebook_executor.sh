...
STAGING_BUCKET=asl_cloudbuild_$TIMESTAMP
...
GIT_REPO=asl-ml-immersion
NOTEBOOK_TEST_ALLOWLIST="$GIT_REPO/notebooks/introduction_to_tensorflow/solutions/1_core_tensorflow.ipynb
$GIT_REPO/notebooks/introduction_to_tensorflow/solutions/4_keras_functional_api.ipynb
"

git clone GIT_REPO

gsutil mk -l $LOCATION STAGING_BUCKET

for NOTEBOOK in NOTEBOOK_TEST_ALLOWLIST ; do

    INPUT_NOTEBOOK_FILE=gs://STAGING_BUCKET/NOTEBOOK
    OUTPUT_NOTEBOOK_FOLDER=gs://STAGING_BUCKET/NOTEBOOK/output
