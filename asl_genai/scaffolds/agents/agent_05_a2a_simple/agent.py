...
math_agent = RemoteA2aAgent(
    name="math_agent",
    description="Handles requests involving addition or subtraction.",
...
root_agent = Agent(
    ...
    "3. 'math_agent': Handles mathematical operations. Delegate to it for these. "
    "Analyze the user's query. If it's a greeting, delegate to 'greeting_agent'. If it's a farewell, delegate to 'farewell_agent'. "
    "If it's a math request, delegate to 'math_agent'. "
    "For anything else, respond appropriately or state you cannot handle it.",
    sub_agents=[greeting_agent, farewell_agent, math_agent],
)