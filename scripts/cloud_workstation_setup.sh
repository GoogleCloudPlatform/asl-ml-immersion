...
echo "To connect your local IDE run the next command:"
echo ""
echo "   gcloud workstations start-tcp-tunnel $WORKSTATION_NAME \\"
echo "     --region=$REGION --cluster=$CLUSTER_NAME --config=$CONFIG_NAME \\"
echo "     --project=$PROJECT_ID --local-host-port=:59383 22"
echo ""
echo "Detailed instructions to:"
echo "https://docs.cloud.google.com/workstations/docs/develop-code-using-local-vscode-editor"
echo "================================================================"